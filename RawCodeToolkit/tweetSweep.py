...
# tweetSweep queries the twitter database for tweets containing
# a specified keyword (company name or alias) 
import tweepy
import datetime
import calendar
import time
...
# Twitter limits query rate so we must throttle query frequency
...
# Search tweets in specified range
